Rswag::Ui.configure do |c|
  ...
  c.openapi_endpoint "/api-docs/v1/live/swagger.yaml", "API V1 Docs"
  c.openapi_endpoint "/api-docs/v1/swagger.yaml", "API V1 Docs (incl. smoke tests)" if Settings.environment.eql?("non-live")
